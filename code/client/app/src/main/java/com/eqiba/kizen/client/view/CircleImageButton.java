...
public class CircleImageButton extends android.support.v7.widget.AppCompatImageButton {
    ...
    public CircleImageButton(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleImageButton(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
